...
export const INTEGRATION_REGISTRY: IntegrationDef[] = [
  ...
  },
  {
    ...
    docUrl:
      "https://help.aliyun.com/zh/captcha/captcha2-0/user-guide/quick-start",
    setupGuide: [
      {
        title: "1. 开通验证码 2.0",
        content:
    ...
    configFields: [
      ...
      },
      {
        ...
        helpUrl:
          "https://help.aliyun.com/zh/captcha/captcha2-0/user-guide/scene-management",
        public: true,
        required: true,
      },
      {
        ...
        helpUrl:
          "https://help.aliyun.com/zh/captcha/captcha2-0/user-guide/regions-and-endpoints",
        public: true,
      },
    ],
  },
...
export const INTEGRATION_SLUGS = new Set(
  INTEGRATION_REGISTRY.map((item) => item.slug),
);
