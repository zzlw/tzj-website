import { Check, Eye, Flame, Gauge, ShieldCheck, Thermometer, Wind } from 'lucide-react';
...
const IMAGE = '/media/burn-room.webp';
const FEATURE_ICONS = [Flame, Eye, Wind, Thermometer, ShieldCheck, Gauge] as const;
const RELATED_HREFS = ['/burn-rooms', '/burn-rooms/fire-simulation', '/solutions/fire-rescue'];

export async function generateMetadata() {
  return createPageMetadata({ namespace: 'pages.burnRoomsCfbt', path: '/burn-rooms/cfbt' });
}
      ...
      <JsonLd
        data={[
          breadcrumbJsonLd([
            ...
            { name: t('breadcrumb.current'), path: '/burn-rooms/cfbt' },
          ]),
          productJsonLd({
