...
const LINE = requireProductLine('burn-rooms');

/** 与 i18n `features` 数组顺序一一对应 */
const FEATURE_IDS = ['interlock', 'hightemp', 'inspect', 'replace', 'modular', 'nfpa'] as const;
...
export async function generateMetadata(): Promise<Metadata> {
  return createPageMetadata({
    namespace: 'pages.burnRoomsLiner',
    path: '/burn-rooms/liner',
      ...
      <JsonLd
        data={[
          breadcrumbJsonLd([
            ...
            { name: t('meta.title'), path: '/burn-rooms/liner' },
          ]),
          productJsonLd({
            name: LINE.title,
