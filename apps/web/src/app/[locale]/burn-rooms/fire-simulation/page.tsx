...
import { Flame, Gauge, Repeat, Leaf, SlidersHorizontal, ShieldCheck } from "lucide-react";
...
const RELATED_HREFS = ["/burn-rooms/cfbt", "/education-center", "/solutions/enterprise"];

export async function generateMetadata() {
  return createPageMetadata({ namespace: "pages.burnRoomsFireSimulation", path: "/burn-rooms/fire-simulation" });
}
