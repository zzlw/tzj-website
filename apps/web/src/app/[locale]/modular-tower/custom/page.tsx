...
const RELATED_HREFS = ["/modular-tower/series", "/modular-tower/vs-containers", "/resources/design-center"];

export async function generateMetadata() {
  return createPageMetadata({ namespace: "pages.modularTowerCustom", path: "/modular-tower/custom" });
}
  ...
  return (
    <div className="pb-20">
      ...
      <section>
        <Container className="pt-16 lg:pt-24">
          <div className="relative aspect-[21/9] overflow-hidden bg-neutral-900">
            <Image src="/media/modular-construction.jpg" alt={t("gallery.imageAlt")} fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
          </div>
        </Container>
      </section>
      ...
      <section className="bg-neutral-100">
        <Container className="py-16 lg:py-24">
          <SectionHeading
            eyebrow={t("exampleSection.eyebrow")}
            title={t("exampleSection.title")}
          />
