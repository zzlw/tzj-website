...
export async function generateMetadata() {
  return createPageMetadata({ namespace: "pages.modularTowerVsContainers", path: "/modular-tower/vs-containers" });
}
        ...
        <Container className="py-16 lg:py-24">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-4 text-base leading-relaxed text-secondary-text">{t("overview.body")}</p>
            </div>
          </div>
        </Container>
      </section>
              ...
              <tbody>
                {rows.map((r) => (
                  <tr key={r.feature} className="border-b border-neutral-300 align-top">
                    ...
                    <td className="p-4 text-sm leading-relaxed text-secondary-text">{r.container}</td>
                  </tr>
                ))}
              </tbody>
            </table>
