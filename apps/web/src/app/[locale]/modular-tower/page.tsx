...
export default async function ModularTowerPage() {
  ...
  const compareRows = t.raw("compareRows") as Array<{ label: string; modx: string; container: string }>;
            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="bg-neutral-900 text-white">
                  ...
                  <th className="p-4 text-sm font-bold text-primary">{t("compareSection.headers.modular")}</th>
              ...
              <tbody>
                {compareRows.map((row, i) => (
                  <tr key={row.label} className={i % 2 ? "bg-neutral-100" : "bg-white"}>
                    <td className="p-4 align-top text-sm font-bold text-neutral-900">{row.label}</td>
                    ...
                    <td className="p-4 align-top">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-sm leading-relaxed text-secondary-text">{row.container}</span>
                      </div>
                    </td>
                  </tr>
                ))}
