...
import { Dumbbell, RotateCw, Activity, HeartPulse, Gauge, Wrench } from "lucide-react";
...
const IMAGE = "/media/galvanized-stair.webp";
const FEATURE_ICONS = [Dumbbell, RotateCw, Activity, HeartPulse, Gauge, Wrench] as const;
const RELATED_HREFS = ["/accessories/competition", "/specialized-training/psychological", "/accessories"];

export async function generateMetadata() {
  return createPageMetadata({ namespace: "pages.accessoriesFitnessEquipment", path: "/accessories/fitness-equipment" });
}
