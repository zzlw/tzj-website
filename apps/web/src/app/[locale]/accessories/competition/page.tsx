...
import { Trophy, Timer, Flag, Users, Gauge, ClipboardCheck } from "lucide-react";
...
const IMAGE = "/media/tower-prairieville.jpg";
const FEATURE_ICONS = [Flag, Timer, Trophy, Users, Gauge, ClipboardCheck] as const;
const RELATED_HREFS = ["/accessories/fitness-equipment", "/fixed-tower", "/solutions/enterprise"];

export async function generateMetadata() {
  return createPageMetadata({ namespace: "pages.accessoriesCompetition", path: "/accessories/competition" });
}

export default async function CompetitionPage() {
  const t = await getTranslations("pages.accessoriesCompetition");
      ...
      <JsonLd
        data={[
          breadcrumbJsonLd([
            ...
            { name: t("breadcrumb.current"), path: "/accessories/competition" },
          ]),
          productJsonLd({
            name: t("jsonLd.productName"),
            description: t("jsonLd.productDescription"),
            path: "/accessories/competition",
            image: IMAGE,
          }),
        ]}
      />
