...
const FEATURE_ICONS = [Biohazard, Flame, ArrowUpDown, Search, Box, Hammer, Wind, MountainSnow, LayoutGrid, Droplets] as const;
    ...
    <div className="pb-20">
      <section className="relative flex min-h-[460px] items-end overflow-hidden bg-neutral-900 pt-16">
        ...
        <Container className="rb-on-media relative z-10 py-14 lg:py-20">
          ...
          <p className="mt-5 max-w-xl text-base text-white/85 md:text-lg">{t("hero.description")}</p>
          <div className="mt-8">
      ...
      <section id="maritime" className="scroll-mt-24 bg-neutral-100">
        <Container className="py-16 lg:py-24">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            />
            <div>
              <p className="mb-5 text-base leading-relaxed text-neutral-900">{t("maritime.lead")}</p>
