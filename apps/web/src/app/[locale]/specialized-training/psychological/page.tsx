...
const LINE = requireProductLine('psychological');

/** 与 i18n `features` 数组顺序一一对应 */
const FEATURE_IDS = ['highangle', 'willpower', 'teamwork', 'stress', 'levels', 'safety'] as const;
      ...
      <JsonLd
        data={[
          breadcrumbJsonLd([
            ...
            { name: t('meta.title'), path: '/specialized-training/psychological' },
          ]),
          productJsonLd({
            name: LINE.title,
