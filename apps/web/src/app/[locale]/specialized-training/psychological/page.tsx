...
import { Brain, Mountain, Users, Zap, Gauge, ShieldCheck } from "lucide-react";
...
const RELATED_HREFS = ["/specialized-training/rope-rescue", "/accessories/fitness-equipment", "/solutions/military"];

export async function generateMetadata() {
  return createPageMetadata({ namespace: "pages.specializedTrainingPsychological", path: "/specialized-training/psychological" });
}
...
export default async function PsychologicalPage() {
  ...
  return (
    <>
      <JsonLd data={[breadcrumbJsonLd([{ name: tBread("home"), path: "/" }, { name: t("breadcrumb.parent"), path: "/specialized-training" }, { name: t("breadcrumb.current"), path: "/specialized-training/psychological" }]), productJsonLd({ name: t("jsonLd.productName"), description: t("jsonLd.productDescription"), path: "/specialized-training/psychological", image: IMAGE })]} />
      <div className="pb-20">
