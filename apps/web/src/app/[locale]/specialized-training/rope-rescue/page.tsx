...
const LINE = requireProductLine('rope-rescue');

/** 与 i18n `features` 数组顺序一一对应 */
const FEATURE_IDS = ['terrain', 'vertical', 'anchors', 'stretcher', 'multipath', 'safety'] as const;
      ...
      <JsonLd
        data={[
          breadcrumbJsonLd([
            ...
            { name: t('meta.title'), path: '/specialized-training/rope-rescue' },
          ]),
          productJsonLd({
            name: LINE.title,
