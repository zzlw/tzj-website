import { Anchor, ArrowDownUp, Check, LifeBuoy, Mountain, Route, ShieldCheck } from 'lucide-react';
...
const RELATED_HREFS = [
  ...
  '/solutions/mine-rescue',
  '/fixed-tower',
];

export async function generateMetadata() {
  return createPageMetadata({
    namespace: 'pages.specializedTrainingRopeRescue',
    path: '/specialized-training/rope-rescue',
  });
}
      ...
      <JsonLd
        data={[
          breadcrumbJsonLd([
            ...
            { name: t('breadcrumb.current'), path: '/specialized-training/rope-rescue' },
          ]),
          productJsonLd({
