...
const SECTION_ICONS = [FileText, Ruler, ClipboardCheck, HelpCircle, CalendarDays, Newspaper, ShieldCheck, BookOpen] as const;
            ...
            {sections.map((s, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-2 flex-1 text-sm leading-relaxed text-secondary-text">{s.desc}</p>
