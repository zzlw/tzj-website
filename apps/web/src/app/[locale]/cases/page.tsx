...
} from "@/components/content/ContentListShell";
      ...
      <section>
        <Container className="py-16 lg:py-24">
          ...
          >
            {items.length === 0 ? (
              ...
              <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {items.map((item) => {
                  ...
                  const client =
                    (item as { client?: string }).client ?? item.clientName ?? "";
                  return (
                    <Link
                      key={item.id}
                    ...
                    >
                      ...
                      <div className="flex flex-1 flex-col p-6">
                        ...
                        {client ? (
                          <p className="mt-2 text-xs text-secondary-text">{tContent("labels.client")}{client}</p>
                        ) : null}
            ...
            <ContentPaginationShell>
              <ContentPagination pagination={pagination} unit={tContent("pagination.units.cases")} />
            </ContentPaginationShell>
          </ContentListShell>
        </Container>
      </section>
