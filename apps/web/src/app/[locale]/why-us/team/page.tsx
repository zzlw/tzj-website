import { Flame, HardHat, Handshake } from "lucide-react";
  ...
  return (
    <div className="pb-20">
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {team.map((m) => (
              <div key={m.name} className="border border-neutral-300 bg-white p-6">
                <span className="text-xs font-bold uppercase tracking-wide text-primary">{m.tag}</span>
      ...
      <section className="bg-neutral-100">
        <Container className="py-16 lg:py-24">
          <SectionHeading eyebrow={t("whySection.eyebrow")} title={t("whySection.title")} description={t("whySection.description")} />
          <div className="mt-10"><FeatureGrid items={why} columns={3} /></div>
        </Container>
      </section>
