...
exports.SOLUTION_META = [
    {
        ...
        focusIcons: [lucide_react_1.Flame, lucide_react_1.Building2, lucide_react_1.Beaker, lucide_react_1.ClipboardCheck],
    ...
    },
    {
        ...
        focusIcons: [lucide_react_1.Building2, lucide_react_1.Target, lucide_react_1.Shield, lucide_react_1.Users],
        recommendedHrefs: [
    ...
    },
    {
        ...
        focusIcons: [lucide_react_1.Dumbbell, lucide_react_1.Brain, lucide_react_1.Mountain, lucide_react_1.Layers],
        recommendedHrefs: [
            "/fixed-tower",
    ...
    },
    {
        ...
        focusIcons: [lucide_react_1.Layers, lucide_react_1.Flame, lucide_react_1.Mountain, lucide_react_1.ClipboardCheck],
        recommendedHrefs: [
            "/modular-tower",
            "/specialized-training/rope-rescue",
            "/burn-rooms",
    ...
    },
    {
        ...
        focusIcons: [lucide_react_1.GraduationCap, lucide_react_1.Building2, lucide_react_1.Users, lucide_react_1.ClipboardCheck],
        recommendedHrefs: [
            "/education-center",
            "/fixed-tower/series",
            "/modular-tower",
    ...
    },
    {
        ...
        focusIcons: [lucide_react_1.Beaker, lucide_react_1.Flame, lucide_react_1.Trophy, lucide_react_1.ClipboardCheck],
        recommendedHrefs: [
            "/accessories/hazmat",
            "/burn-rooms/fire-simulation",
