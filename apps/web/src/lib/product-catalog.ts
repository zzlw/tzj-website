...
export const PRODUCT_FAMILIES: ProductFamily[] = [
  ...
  },
  {
    ...
    title: "实火与燃烧训练",
    description: "安全可控的真实火场与烟火特性训练 —— 互锁衬里、CFBT 与消防模拟，支撑高强度实战演练。",
  },
  {
    id: "specialized",
    navKey: "productFamilySpecialized",
    title: "专项场景训练",
    description: "面向特定任务的高度专业化场景 —— 海事、战术、危化品、绳索与心理拓展，贴近真实、可反复演练。",
  },
  {
    id: "accessories",
...
export const PRODUCT_LINES: ProductLine[] = [
  ...
  // D. 训练器械与道具（1，含 3 个子 SKU）
  {
    ...
    subLinks: [
      ...
      { title: "体能抗眩晕器械", href: "/accessories/fitness-equipment", navKey: "accessoriesFitness" },
      { title: "竞赛类训练设施", href: "/accessories/competition", navKey: "accessoriesCompetition" },
    ],
  },
];
