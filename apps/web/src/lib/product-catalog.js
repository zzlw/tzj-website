...
exports.PRODUCT_LINES_BY_FAMILY =
  exports.PRODUCT_NAV_DIVIDER_BEFORE =
  exports.PRODUCT_LINES =
  exports.PRODUCT_FAMILIES =
  exports.PRODUCT_LINE_COUNT =
    void 0;
exports.linesByFamily = linesByFamily;
exports.familyForLine = familyForLine;
exports.PRODUCT_LINE_COUNT = 13;
exports.PRODUCT_FAMILIES = [
  {
    id: 'towers',
...
exports.PRODUCT_NAV_DIVIDER_BEFORE = [4, 7, 12];
function linesByFamily(familyId) {
  return exports.PRODUCT_LINES.filter((line) => line.family === familyId);
}
function familyForLine(line) {
  return exports.PRODUCT_FAMILIES.find((family) => family.id === line.family);
}
exports.PRODUCT_LINES_BY_FAMILY = exports.PRODUCT_FAMILIES.map((family) => ({
  family,
