...
exports.getCaseBySlug = getCaseBySlug;
exports.getAllCaseSlugs = getAllCaseSlugs;
exports.caseStudies = [
    {
        ...
        summary: "为省级消防救援总队建设综合训练基地，包含固定训练塔、CFBT 燃烧室及绳索救援训练区，满足全省消防指战员年度轮训需求。",
        highlights: [
            "7 层固定训练塔，含电梯井与楼梯塔",
            "双燃烧室配置，支持 CFBT 实战训练",
    ...
    },
    {
        ...
        summary: "为公安特警支队定制攀登与破拆综合训练设施，涵盖垂直攀登、窗口突入、绳索下降等多场景战术训练。",
        highlights: [
            "定制平面布局，融入特警战术场景",
            "多种训练道具集成（破拆口、绳索锚点）",
            "模块化燃烧室可独立使用",
...
function getCaseBySlug(slug) {
    return exports.caseStudies.find((c) => c.slug === slug);
}
function getAllCaseSlugs() {
    return exports.caseStudies.map((c) => c.slug);
}
