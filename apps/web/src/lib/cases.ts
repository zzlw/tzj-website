...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    summary:
      "为矿山救援队伍建设地下空间模拟与垂直救援训练设施，提升复杂环境下的救援实战能力。",
    highlights: [
      "模拟地下巷道与竖井救援场景",
      "耐高腐蚀环境镀锌钢结构",
      "集成烟雾发生器与热训练系统",
  ...
  },
  {
    ...
    summary:
      "为高校安全工程专业建设实训教育基地，涵盖消防、危化品处置、应急救援等教学实训场景。",
    highlights: [
      "教学友好型低强度燃烧室",
      "多专业共用开放式训练平台",
      "完整图纸供教学参考",
  ...
  },
  {
    ...
    summary:
      "为景区建设户外拓展训练与高空作业训练设施，兼顾游客体验与专业救援队伍训练需求。",
    highlights: [
      "景观融合式外观设计",
      "高空绳索与攀岩训练集成",
      "安全护栏与防坠系统完备",
  ...
  },
  {
    ...
    summary:
      "建设华南地区标杆 CFBT（实火训练）中心，配备互锁隔热衬里燃烧室与完整热烟训练系统。",
    highlights: [
