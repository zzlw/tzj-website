...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      {
        paragraphs: [
          '“我们该如何起步？”这是规划训练设施时最常被问到的问题。一座训练塔的价值，不在于它有多高、多大，而在于它能否支撑起你真正需要的训练科目，并在长期使用中持续可用。',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '把这些决策交给既懂消防、又懂工程的团队，能帮你在预算之内做出合理工程权衡。',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        heading: '分期建设的现实意义',
        paragraphs: [
          '分期不仅缓解预算压力，也让训练能力与队伍一起成长：第一期打基础，第二期上高层与火场，第三期接入危化品或战术场景——全程无需推倒重建，保留扩展空间，降低重复建设成本。',
        ],
      },
    ],
  },
