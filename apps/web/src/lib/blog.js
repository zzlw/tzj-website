...
exports.getAllBlogSlugs = getAllBlogSlugs;
exports.blogPosts = [
    {
        slug: "plan-fire-training-tower",
        category: "训练设施",
        title: "如何规划一座实战火场训练塔：从目标到落地的完整指南",
        excerpt: "训练塔的规划远不止“盖一栋楼”。本文从训练目标拆解、场地评估、塔型选型到预算与分期建设，系统梳理从构想到落地的关键决策。",
        readTime: "8 分钟",
        date: "近期",
...
function getBlogPostBySlug(slug) {
    return exports.blogPosts.find((p) => p.slug === slug);
}
function getAllBlogSlugs() {
    return exports.blogPosts.map((p) => p.slug);
}
