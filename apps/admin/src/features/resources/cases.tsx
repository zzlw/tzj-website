...
export const casesConfig: ResourceConfig<CaseItem> = {
  ...
  columns: [
    ...
    { key: "caseType", header: "类型", sortable: true, cell: (r) => labelOf(CASE_TYPE_OPTIONS, r.caseType) },
    ...
    { key: "completionDate", header: "发布日期", sortable: true, cell: (r) => formatDate(r.completionDate) },
