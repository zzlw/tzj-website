      ...
      >
        ...
        {manageable ? (
          <Can anyPerm={["docs.create"]}>
            <div className="absolute right-0.5 top-1/2 flex -translate-y-1/2 items-center rounded-md bg-muted/95 opacity-0 shadow-sm transition-opacity group-hover:opacity-100 group-focus-within:opacity-100">
              <Button
                type="button"
                variant="ghost"
                size="icon"
